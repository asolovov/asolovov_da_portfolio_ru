...
|[Исследования рынка московских ресторанов](https://github.com/asolovov/asolovov_portfolio/tree/main/rest_msk)|Проведение исследования рынка московских точек общественного питания с целью подготовки презентации для инвестора нового современного кафе |Pandas, seaborn, matplotlib.pyplot, pymystem3, парсинг по dadata API
...
|[Исследование опроса лояльности клиентов](https://github.com/asolovov/asolovov_portfolio/tree/main/telecom_nps)|Исследование опроса лояльности клиентов телекоммуникационной компании с помощью построение интерактивного дэшборда в Tableau и создание витрины из базы данных SQL-lite| Pandas, SQL-lite, Tableau
|[Маркетинговое исследование пользовательской активности](https://github.com/asolovov/asolovov_portfolio/tree/main/marketing)|Исследование пользовательской активности приложения, когортный анализ, расчет LTV, ROI, CAC, удержания и конверсии. Анализ эффективности маркетинговой стратегии и рекомендации по улучшению.|pandas, numpy, datetime, pyplot, функции
